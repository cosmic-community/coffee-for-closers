...
export default function CompleteProfilePage() {
  ...
  useEffect(() => {
    ...
    if (user && user.metadata.job_title !== 'Not specified') {
  ...
  const isStep1Valid = () => {
    return formData.job_title && formData.company && 
        ...
        <div className="card">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Welcome, {user.metadata.display_name}! Let's finish setting up your profile
            </p>
          </div>
